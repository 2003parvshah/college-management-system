...
function getresult($sess1=0 , $sess2=0 , $sess3=0 , $att1=0 , $att2=0 , $att3=0 ,$total_att1=0 , $total_att2=0 , $total_att3=0 ,$block=0 ,  $viva=0 , $practical=0 , $termwork=0 , $external=0 , $sid=0 , $sem =1, $subject="0" )
{
    $grade = "";
    $attmark = 0;
    $sub_point = 0 ;
...
while ($row = $result1->fetch_assoc()) {
    ...
    $grade =  getresult($row['sess1'] , $row['sess2'] , $row['sess3'] , $row['att1'] , $row['att2'] , $row['att3'] ,$row['total_att1'] , $row['total_att2'] , $row['total_att3'] ,$row['block'] ,  $row['viva'] , $row['practical'] , $row['termwork'] , $row['external']  , $row['sid'], $row['sem'] , $row['subject']);
