...
const CustomPopup = ({ onClose }) => {
  ...
  const updatepassword = async (e) => {
    ...
    try 
    {
      const apiUrl = 'http://localhost/api/sdp/login/updatenewpassword.php'; // Replace with your API endpoint
  ...
  const checkotp = async (e) => {
    ...
    try 
    {
      const apiUrl = 'http://localhost/api/sdp/login/checkOtp.php'; // Replace with your API endpoint
      // console.log(Email , OTP);
      const response2 = await fetch(apiUrl, {
        method: 'POST',
        headers: {
  ...
  const handleForgot = async (e) => {
    ...
    try 
    {
      const apiUrl = 'http://localhost/api/sdp/login/sendotp.php'; 
...
const ApplyLogin = () => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const apiUrl = 'http://localhost/api/sdp/login/login.php'; // Replace with your API endpoint
