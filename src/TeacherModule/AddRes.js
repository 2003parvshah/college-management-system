...
const handleInputChange = (index, event) => {
  ...
  const loadsem = async () => {
    try {
      ...
      const apiUrl = "http://localhost/api/sdp/teacher/forsubject.php"; // Replace with your API endpoint
  ...
  const loadmarks = async () => {
    try {
      ...
      const apiUrl = "http://localhost/api/sdp/teacher/forsubjectmarks.php"; // Replace with your API endpoint
      const response = await fetch(apiUrl, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const uploadmarks = async () => {
  try {
    ...
    const apiUrl = "http://localhost/api/sdp/teacher/updatemarks.php";
    const response = await fetch(apiUrl, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
const handleSubmitfile = async (event) => {
  ...
  const apiUrl = "http://localhost/api/sdp/teacher/updatemarksusingexcel.php";
