...
const handleFileChange = (event) => {
  ...
  const loadatts = async () => {
    try {
      ...
      const apiUrl = "http://localhost/api/sdp/teacher/forsubjectatt.php"; // Replace with your API endpoint
      const response = await fetch(apiUrl, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const uploadAtts = async () => {
  try {
    ...
    const apiUrl = "http://localhost/api/sdp/teacher/updateatt.php";
    const response = await fetch(apiUrl, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
const handleSubmitfile = async (event) => {
  ...
  const apiUrl = "http://localhost/api/sdp/teacher/addattfile.php";
