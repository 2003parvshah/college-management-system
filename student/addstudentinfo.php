<!-- INSERT INTO `studentbasicinfo` (`name`, `gender`, `birthdate`, `birthplace`, `enrollmentyear`, `degree`, `sid`, `acpc_rank`, `cast_category`, `subcast`, `motherTongue`, `nationality`) VALUES ('parv', 'male', '2003-11-20', 'baroda', '2021', 'betech', '1', '3500', 'hindu', 'vaisnav', 'gujrati', 'india');
 -->
 <?php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($json_data['name'], $json_data['gender'], $json_data['birthdate'], $json_data['birthplace'], $json_data['enrollmentyear'], $json_data['sid'], $json_data['acpc_rank'], $json_data['cast_category'], $json_data['subcast'], $json_data['motherTongue'], $json_data['nationality'], $json_data['after'], $json_data['degree'])) {
        $name = $json_data['name'];
  ...
  $sql = "INSERT INTO studentbasicinfo (name, gender, birthdate, birthplace, enrollmentyear, acpc_rank, cast_category, subcast, motherTongue, nationality, after, degree , gujcat , sid) 
